...
public class CoffeeMachine {
	...
	*/
    private static Coffee espresso = new Coffee(250, 0, 16, 4);
    private static Coffee latte = new Coffee(350, 75, 20, 7);
    private static Coffee cappuccino = new Coffee(200, 100, 12, 6);
  
	private static Coffee selectedCoffee=null;

    private static int cups = 9;
    private static int money = 550;
    private static int water_level = 400;
    private static int milk_level = 540;
    private static int coffee_level = 120;
